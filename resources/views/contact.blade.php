    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <p>Justo sed diam ut sed amet duo amet lorem amet stet sea ipsum, sed duo amet et. Est  dolor  erat sit sit. Dolor diam et erat  ipsum justo sed.</p>
                <div class="d-flex flex-column mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>{{$website_info->phone}}</p>
                </div>
                @endforeach
